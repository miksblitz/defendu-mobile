/**
 * Double low kick — permissive match once the bespoke rep detector accepts the rep.
 */

import type { PoseFrame, PoseFeedbackItem, PoseSequence, PoseFocus } from '../../../types';
import { compareRepsWithFocus } from '../../../comparator';

export function compareRepWithFeedbackDoubleLowKick(
...
export function compareRepWithFeedbackAnyDoubleLowKick(
  userFrames: PoseFrame[],
